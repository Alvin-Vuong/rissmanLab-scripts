function [subjs_used, feature_set] = features_smof_lower(conn_type, val_type, percent, net1, net2)
%
%==========================================================================================
% features_smof_lower.m
%
% Take in network name(s), and a type of relation (specified in "Connectivities Naming.xlsx").
%
% Creates a feature set containing functional connectivity values masked by the bottom (100-x)% of 
