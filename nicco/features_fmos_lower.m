function [subjs_used, feature_set] = features_fmos_lower(conn_type, val_type, percent, net1, net2)
%
%==========================================================================================
...
%
% Creates a feature set containing mean/volume structural connectivity values masked by the
% bottom (100-x)% of functional connectivity values ranked in descending order for each network or network pair.
